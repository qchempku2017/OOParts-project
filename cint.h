...
FINT cint1e_ovlp_cart(double *buf, int *shls, int *atm, int natm, int *bas, int nbas, double *env);
FINT cint1e_nuc_cart(double *buf, int *shls, int *atm, int natm, int *bas, int nbas, double *env);
FINT cint1e_kin_cart(double *buf, int *shls, int *atm, int natm, int *bas, int nbas, double *env);
